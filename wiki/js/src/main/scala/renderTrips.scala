  ...
  def apply(o : SOntItem, change : String => Unit, list : (String, Any) => Unit) : org.scalajs.dom.raw.Node = {
    ...
    div(
      ...
      div(cls := "row")(
        div(cls := "col s6")(
          div(id := "childList")(
            buildList(o.children, "Children", (s : String) =>{() => list(s, OntLookup)}, "white", "purple darken-4")
          ),
          buildList(o.words, "Lexicon", (s : String) =>{() => list(s, WordLookup)}, "white", "red darken-4")
        ),
        div(id := "wordNetList", cls := "col s6")(
